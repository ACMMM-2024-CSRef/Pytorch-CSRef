"""
    train
    OMP_NUM_THREADS=1 CUDA_VISIBLE_DEVICES=0 PORT=23450 bash tools/train_speech.sh configs/csref_refcocog_speech.py 1
...
dataset.audio_root = "./data/audios/refcocog_keepcomma"
