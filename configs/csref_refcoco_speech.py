"""
    train
    OMP_NUM_THREADS=1 CUDA_VISIBLE_DEVICES=0 PORT=23440 bash tools/train_speech.sh configs/csref_refcoco_speech.py 1
"""
...
dataset.audio_root = "./data/audios/refcoco"
